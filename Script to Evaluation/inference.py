...
#cfg.MODEL.WEIGHTS = '/banano/uvas/racimos/datasets_entrenamiento/output/modelo_racimos.pth'
cfg.MODEL.WEIGHTS = '/banano/uvas/racimos/datasets_entrenamiento/output/modelo_racimos_v2_2.pth'
...
df.to_csv(dataset+'_inferencia.csv')